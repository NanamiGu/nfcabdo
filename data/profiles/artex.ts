...
export const artexProfile: CompanyProfile = {
  type: "company",
  id: "prof_artex_01",
  slug: "artex",
  status: "active",
  ...
  services: [
    {
      ...
      description:
        "Complete visual positioning, logo systems, brand guidelines, and distinctive typographic hierarchy.",
      icon: "sparkles",
      price: "From $4,000",
    },
    {
      ...
      description:
        "Flagship corporate websites, 3D interactive web apps, and headless e-commerce built on Next.js.",
      icon: "globe",
      price: "From $6,500",
    },
    {
      ...
      description:
        "End-to-end UX wireframing, high-fidelity prototypes, and comprehensive design systems.",
      icon: "layers",
      price: "From $3,500",
    },
    {
      ...
      description:
        "3D product rendering, brand launch films, and interactive micro-animations that captivate.",
      icon: "film",
      price: "From $2,800",
    },
  ],
  ...
  projects: [
    {
      ...
      description:
        "Luxury Swiss timepiece brand launch, interactive 3D configurator, and global e-commerce flag.",
    ...
    },
    {
      ...
      description:
        "Complete brand transformation and mobile banking interface for 500k+ active users.",
    ...
    },
    {
      ...
      description:
        "Minimalist architectural monograph and responsive portfolio with spatial layout rhythm.",
  ...
  products: [
    {
      name: "Artex Brand Sprint Guide",
      title: "Artex Brand Sprint Guide",
      description:
        "Our proprietary 5-day brand sprint framework used by top industry leaders.",
      price: "$199",
  ...
  testimonials: [
    {
      quote:
        "ARTEX reimagined our brand presence from the ground up. Their attention to craft and technical execution is unmatched.",
      text: "ARTEX reimagined our brand presence from the ground up. Their attention to craft and technical execution is unmatched.",
    ...
    {
      quote:
        "Working with ARTEX was effortless. The website is an absolute work of art and delivers stellar conversion metrics.",
      text: "Working with ARTEX was effortless. The website is an absolute work of art and delivers stellar conversion metrics.",
      author: "David Chen",
      name: "David Chen",
  ...
  links: [
    ...
    },
    {
      ...
      description:
        "28-page PDF overview of team, process, and verified client outcomes",
  ...
  booking: {
    ...
    description:
      "Meet with our creative director to discuss scope, timeline, and deliverables.",
  },
