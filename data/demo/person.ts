...
export const personDemoProfile: Profile = {
  type: "person",
  ...
  profile: {
    ...
    verified: true,
    skills: ["Next.js 15", "TypeScript", "Tailwind CSS", "React Server Components", "Framer Motion", "UI/UX Architecture"]
  },
  ...
  services: [
    ...
    },
    {
      ...
      description: "Scalable component libraries with tokenized Tailwind CSS, full accessibility, and Framer Motion micro-interactions.",
      icon: "palette",
      price: "From $1,800"
    },
    {
      title: "Web Performance & SEO Audit",
      description: "Deep Core Web Vitals optimization, bundle shrinking, and crawlability improvements.",
      icon: "zap",
      price: "From $950"
    }
  ],
  ...
  projects: [
    {
      ...
      description: "Real-time institutional liquidity dashboard handling 10k+ events/sec with zero latency.",
    ...
    },
    {
      ...
      description: "Open-source enterprise component kit with strict WCAG 2.1 AA compliance.",
    ...
    },
    {
      ...
      description: "Immersive 3D portfolio and interactive product showcase for architectural lighting.",
  ...
  products: [
    {
      ...
      description: "Production-ready, data-driven digital business card system with vCard support.",
      price: "$49",
      badge: "Best Seller",
  ...
  testimonials: [
    {
      quote: "Amine delivered our flagship platform two weeks ahead of schedule. The UX is buttery smooth and our conversion rate jumped by 34%.",
  ...
  booking: {
    ...
    description: "Let's explore your product requirements, tech stack, and timeline."
  },
